$(document).ready(function(){
  ...
  function currentContent(home,porfolio,about,findFlag,currentPg){
    $(".home").html(home);
    ...
    if(currentPg == 'home'){
      $("#loader").fadeToggle();
      $("#pageContent").html(dataHome);
      var selectData  = R.find(R.propEq('id', findFlag))(dataPageHome);
      if(selectData != undefined){     
        var template = Handlebars.compile( $('#template').html() );
        $('#paper').append( template(selectData) );
      }else{
        selectData  = R.find(R.propEq('id', 'en'))(dataPageHome);
        var template = Handlebars.compile( $('#template').html() );
        $('#paper').append( template(selectData) );
      }
      $("#loader").fadeToggle();
      ...
      $("#loader").fadeToggle();
      $("#pageContent").html(dataPortfolio);
      slider.init();
      $('.vk').EmbedVkGallery();
      $("#loader").fadeToggle();
    }
